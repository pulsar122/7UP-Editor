...
char *Apicklist[]=
{
   ...
   "[3][Falsche Versionsnummer!][OK]",
   "[1][Nicht genÅgend Speicher zum|Laden der Pickliste!][Abbruch]"
};
...
char *Afindrep[]=
{
   ...
   "[3][Error: X. freies Muster!|%d schlieûende Elemente fehlen.][OK]",
   "[3][Error: X. freies Muster!|%d îffnende Elemente fehlen.][OK]"
};
...
char *Apicklist[]=
{
   ...
   "[3][Wrong version number!][OK]",
   "[1][Not enough memory to|load picklist!][Abort]"
};
